...
"""
# Plotting
GD_beta_OLS, MSE_1 = GD.Simple_GD(GD.start_beta, method= "OLS", Niterations= 200000, plotting= True)
print("GD OLS: ", GD_beta_OLS.ravel())

GD.lmb = 0.0001
GD.lmb = 0.001
GD_beta_Ridge, MSE_2 = GD.Simple_GD(GD.start_beta, method= "Ridge", Niterations= 200000, plotting= True)
...
SGD_beta_OLS, MSE_3 = GD.Stochastic_GD(GD.start_beta, method= "OLS", batch_size= 40,\
                                        epochs= epochs_num, learning_rate= 0.1, plotting= True)
print("SGD OLS: ", SGD_beta_OLS.ravel())

GD.lmb = 0.0001
GD.lmb = 0.001
SGD_beta_Ridge, MSE_4 = GD.Stochastic_GD(GD.start_beta, method= "Ridge", batch_size= 40, epochs= epochs_num, plotting= True)
