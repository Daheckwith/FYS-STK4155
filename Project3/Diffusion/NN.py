...
if __name__ == '__main__':
    ...
    Dir = "files/"
    filename= f"explicit_scheme_Nx_{Nx}_Nt_{Nt}_NHL_{len(num_hidden_neurons)}_{sum(num_hidden_neurons)}.txt"
    file = Dir + filename 
    f= open(file, "w")
    ...
    plot_NN(t, x, num_hidden_neurons, g_dnn_ag, G_analytical, diff_ag)